  ...
  return (
    <section className="bg-[#0f1c33] border border-blue-900/30 rounded-xl p-6 space-y-4 shadow-lg">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={addRow}
          className="px-3 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-xs font-semibold"
        >
          + Tambah Item
        </button>
      </div>
        ...
        <table className="w-full text-sm border-collapse bg-[#0c1628]">
          <thead className="bg-[#112240]">
            <tr>
              ...
              <th className="p-2 border border-blue-900/40 text-center">Aksi</th>
            </tr>
          </thead>
