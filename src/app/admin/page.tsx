...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    if (selectedCabang) {
      filteredData = filteredData.filter((item) => item.cabang === selectedCabang);
    }

    if (selectedTeknisi) {
      filteredData = filteredData.filter((item) => item.teknisi === selectedTeknisi);
    }
